...
export function ClientNewsPage() {
    ...
    return (
        <div className="w-full bg-[#f8fafc] text-slate-800 pb-24 font-sans min-h-screen">
            ...
            {/* ── Hero Banner ─────────────────────────────────────────── */}
            <div className="relative pt-[88px] overflow-hidden">
            ...
            {/* ── Newsletter Signup ─────────────────────────────────────── */}
            <div className="mt-24 bg-[#0c1220] text-white">
                <div className="max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12">
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                        <div className="relative hidden lg:block">
                            <img
                                src="https://images.unsplash.com/photo-1444201983204-c43cbd584d93?auto=format&fit=crop&w=800&q=80"
                                alt="Newsletter"
                                className="w-full h-full object-cover opacity-40"
                            />
                            <div className="absolute inset-0 bg-gradient-to-r from-transparent to-[#0c1220]" />
                        </div>
                        <div className="py-20 px-8 md:px-14">
                            <div className="flex items-center gap-2 mb-5">
                                <div className="w-8 h-px bg-cyan-500" />
                                <span className="text-cyan-400 font-bold tracking-[0.25em] uppercase text-xs">The Grandeur Journal</span>
                            </div>
                            <h3 className="text-3xl md:text-4xl font-extrabold text-white leading-tight mb-4">
                                Stay Ahead of<br />
                                <span className="text-cyan-400 font-light italic">Every Exclusive Offer</span>
                            </h3>
                            <p className="text-slate-400 text-sm leading-relaxed mb-8 max-w-md">
                                Join over 12,000 discerning travellers who receive our curated newsletter.
                            </p>
                            {subscribed ? (
                                <div className="border border-cyan-500/30 bg-cyan-500/5 p-8 text-center">
                                    <StarIcon className="w-10 h-10 text-cyan-400 mx-auto mb-3" />
                                    <p className="font-bold text-white text-lg mb-1">You're on the list.</p>
                                    <p className="text-slate-400 text-sm">Welcome to The Grandeur family.</p>
                                </div>
                            ) : (
                                <form onSubmit={handleSubscribe}>
                                    <div className="flex flex-col sm:flex-row gap-0 border border-white/15">
                                        <input
                                            id="newsletter-email"
                                            type="email"
                                            required
                                            ...
                                            className="flex-1 bg-transparent text-white placeholder-slate-500 px-5 py-4 focus:outline-none text-sm"
                                        />
                                        <button type="submit" className="bg-cyan-600 hover:bg-cyan-500 text-white px-8 py-4 font-bold uppercase tracking-widest text-xs transition-colors whitespace-nowrap">
                                            Subscribe
                                        </button>
                                    </div>
                                </form>
